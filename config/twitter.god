MERB_ROOT = File.dirname(File.dirname(__FILE__)
...
God.watch do |w|
  script = "#{MERB_ROOT}/config/conume_tweets"
  w.name = "consume_tweets"
  w.group = "twitter"
  ...
  w.pid_file = "#{MERB_ROOT}/log/workling.pid"
